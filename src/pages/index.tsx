...
export default function Home(props) {
    ...
    const { inViewport } = useInViewport(ref, { rootMargin: '-15% 0px' }, { disconnectOnLeave: false }, {});
            ...
            >
                <Flex flexDir="column" py="1%" px="15%" mt="15.2%" width="100%">
                    <Flex>
                        ...
                        <Flex w="50%">
                            <Image w="100%" h="70%" src="\images\illustrations\manLandingPage.svg"></Image>
                        </Flex>
                    </Flex>
                    <ScaleFade initialScale={0.9} in={inViewport} whileHover={{ scale: 1.1 }}>
                        <Flex ref={ref}>
                            ...
                            >
                                <SwiperSlide>
                                    <SliderContent
                                        image="peopleSliderLandingPage.svg"
                                        title="Aprenda e ensine"
                                        description="Ensine sua lingua nativa e aprenda outros idiomas"
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SliderContent
                                        ...
                                        description="Aprender e ensinar se tornou mais divertido"
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SliderContent
                                        image="peopleSliderLandingPage.svg"
                                        title="Compartilhe o seu progresso"
                                        description="Poste e interaja com varias pessoas"
                                    />
                                </SwiperSlide>
                                <SwiperSlide>
                                    <SliderContent
                                        ...
                                        description="Fique no topo ganhando o maximo de Xp possivel"
                                    />
                                </SwiperSlide>
                            </Swiper>
                        </Flex>
                ...
                <Flex py="2%" flexDir="column" bgColor="howdyColors.mainBlack" w="100%" justify="center" align="center">
                    ...
                    <Flex h={1200} w="100%">
                        <Flex align="center" flexDir="column" w="50%">
                            <Image w="100%" h="40%" src="/images/howdy-images/subscription/free-subs.svg"></Image>
                        ...
                        <Flex align="center" flexDir="column" w="50%">
                            <Image w="100%" h="40%" src="/images/howdy-images/subscription/pro-subs.svg"></Image>
                ...
                <Flex w="80%" align={'center'} justify={'space-between'}>
                    <SimpleGrid alignContent="center" justifyContent={'center'} flex="1" gap="5%" minChildWidth="100px">
                        ...
                        <Flex justify="center" gap={10} flexDir={'column'} w="70%">
                            ...
                            <Text fontSize={['sm', 'medium', 'xx-large']}>
                                O mundo afora requer que tenhamos cada vez mais conhecimentos sobre outras línguas. Não
                                vá sozinho!
                            </Text>
                        </Flex>
                    </SimpleGrid>
