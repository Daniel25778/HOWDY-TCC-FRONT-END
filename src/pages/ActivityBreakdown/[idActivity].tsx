...
export default function ActivityBreakdown(props: ActivityBreakdownProps) {
    ...
    function handleBuyActivity() {
        setWasBought(true);
        api.post(`/activities/buy/${idActivity}`)
            .then((response) => {
                toast({
    ...
    return (
        <>
            ...
            <Flex
                flexDir="column"
                boxShadow="4px 4px 4px rgba(0.25, 0.25, 0.25, 0.25)"
                mt="13%"
                ms="60%"
                p="1px"
            ...
            >
                ...
                <Flex justifyContent="center" gap="5%" p="2%" w="100%">
                    <Flex w="30%" gap="3" borderRadius="60px" bg="howdyColors.mainYellow" align="center">
                        <Image
                            height="2.5rem"
                    ...
                    <Flex align="center">
                        ...
                        <Text fontSize={['sm', 'medium', 'large']} color="howdyColors.mainBlue" opacity="60%">
                            {activity?.targetLanguageName}
                        </Text>
                    </Flex>
                </Flex>
                ...
                <Flex flexDir="column" w="100%" p="3%">
                    ...
                    <Flex ml="5%" gap="2%" align="center">
                        ...
                        <Text mb="3%" fontSize={['medium', 'medium', 'large']} color="howdyColors.mainBlack">
                    ...
                    <Flex ml="5%" gap="2%" align="center">
                        ...
                        <Text fontSize={['medium', 'medium', 'large']} color="howdyColors.mainBlack">
                            {activity?.totalQuestion} Questões objetivas
                        </Text>
                    </Flex>
                </Flex>
            </Flex>
            <Flex flexDir="column" justifyContent="center" width="100%" py="10%">
                <Flex mb="4%" flexDir="column" px="25%" py="3%" width="100%" bgColor="howdyColors.mainBlue">
                    ...
                    <Text w="55%" mb="5%" fontSize={['medium', 'medium', 'large']} color="howdyColors.mainWhite">
                        {activity?.activitySubtitle}
                    </Text>
                    <Flex mb="4%" align="center" w="100%">
                        <Text w="5%" fontSize={['medium', 'x-large', 'xx-large']} color="howdyColors.mainYellow">
                            {activity?.totalStars}
                        </Text>
                        <StarRatings
                            starDimension="40px"
                    ...
                    <Text fontSize={['medium', 'large', 'x-large']} color="howdyColors.mainWhite">
                ...
                <Flex flexDir="column" px="25%" w="100%">
                    ...
                    >
                        ...
                        <Grid w="100%" mb="3%" templateColumns="repeat(2, 1fr)" gap={10} flex={1}>
                            {activity &&
                                activity?.teachingTopicList.map((teachingTopic) => (
                                    <Flex gap="5%" justifyContent="center" align={'center'}>
                                        <FcCheckmark size="3rem" />
                                        <Text fontSize={['x-small', 'medium', 'large']} color="howdyColors.mainBlack">
                                            {teachingTopic.teachingTopicText}
                                        </Text>
                                    </Flex>
                                ))}
                        </Grid>
                    ...
                    <Text w="46%" fontSize={['x-small', 'medium', 'large']} color="howdyColors.mainBlack">
                    ...
                    <Flex flexDir="column">
                        <Flex gap="5%" align="center">
                            <ProfilePhotoAndPatent size="5rem" user={activity?.userCreator} />
                            <Text
                                fontWeight="medium"
                                fontSize={['x-small', 'medium', 'xx-large']}
                                color="howdyColors.mainBlack"
                            >
                                {activity?.userCreator?.userName}
                            </Text>
                        </Flex>
                        <Text ml="15%" w="50%" fontSize={['x-small', 'medium', 'large']} color="howdyColors.mainBlack">
                            {activity?.userCreator?.description}
                        </Text>
                    </Flex>
                </Flex>
            </Flex>
