...
export default function () {
    ...
    function handleAddSubscription(monthSubscription) {
        ...
        api.put(`subscription/add/${monthSubscription}`)
            .then((response) => {
                toast({
            ...
            .catch((error) => {
                console.log(`You need at least ${howdyCoinsWanted} howdy coins to get this assignature`);
        ...
        <Flex flexDir="column" w="100%">
            ...
            <Flex flexDir="column" width="100%">
                ...
                <Flex justifyContent="center" width="100%">
                    ...
                    <Flex
                        as="form"
                        action="http://.10.107144.8:3333/buyHowdyCoin"
                        method="POST"
                        h="100%"
                        w="25%"
                        justifyContent="center"
                                ...
                                <AlertDialogOverlay>
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                            ...
                                            <Button
                                                colorScheme="green"
                                                onClick={() => handleAddSubscription(monthSubscription)}
                                                ml={3}
                                            >
                                                SIM
                                            </Button>
